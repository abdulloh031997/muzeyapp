            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li><a href="<?= Url::to(['role/index']); ?>"> <?=\Yii::t('template', 'Role');?></a></li>
                        <li><a href="<?= Url::to(['users/index']); ?>"> <?=\Yii::t('template', 'User');?></a></li>
                    </ul>
                </li>
                <?php elseif(Yii::$app->user->identity->role->id ===2):?>
                    <li>
                    <a href="<?= Url::to(['/']); ?>" class="waves-effect">
                        <i class="ri-dashboard-line"></i>
                        <span><?=\Yii::t('template', 'bosh_sahifa');?></span>
                ...
                <li>
                    <a href="<?= Url::to(['setting/index']); ?>" class="waves-effect">
                        <i class=" ri-shield-star-line"></i>
                        <span> <?=\Yii::t('template', 'settings');?></span>
                    </a>
                </li>
                <li>
                    <a href="<?= Url::to(['logo/index']); ?>" class="waves-effect">
                        <i class=" ri-shield-star-line"></i>
                        <span> <?=\Yii::t('template', 'logo');?></span>
                    </a>
                </li>
                <li>
                    <a href="<?= Url::to(['slider/index']); ?>" class="waves-effect">
                        <i class=" ri-shield-star-line"></i>
                        <span> <?=\Yii::t('template', 'slider');?></span>
                    </a>
                </li>
                <?php endif?>
            </ul>

    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <span class="pt-4 ml-5">
                <a href="<?= Helper::createMultilanguageReturnUrl('uz') ?>"><img src="https://upload.wikimedia.org/wikipedia/commons/8/84/Flag_of_Uzbekistan.svg" width="25px" alt=""> O'zbek </a> <span>|</span> 
                <a href="<?= Helper::createMultilanguageReturnUrl('ru') ?>"><img src="https://upload.wikimedia.org/wikipedia/commons/f/f3/Flag_of_Russia.svg" width="25px" alt=""> Рус</a>
            </span>
        </div>
